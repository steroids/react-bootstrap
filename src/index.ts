...
export default {
    ...
    'content.DetailView': {lazy: () => require('./content/Detail/DetailView').default},
    // 'crud.CrudView': {lazy: () => require('./crud/Crud/CrudView').default},
    ...
    'list.PaginationButtonView': {lazy: () => require('./list/Pagination/PaginationButtonView').default},
    'list.PaginationMoreView': {lazy: () => require('./list/Pagination/PaginationMoreView').default},
