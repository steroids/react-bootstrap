...
import './SingleSwitcherFieldView.scss';

export default function SingleSwitcherFieldView(props: ICheckboxFieldViewProps) {
    const bem = useBem('SingleSwitcherFieldView');
