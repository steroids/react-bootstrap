...
export default {
	...
	"form.AutoCompleteFieldView": {
		lazy: () =>
			require("./form/AutoCompleteField/AutoCompleteFieldView").default,
	},
	"form.ButtonView": {
	...
	"form.CheckboxListFieldView": {
		lazy: () =>
			require("./form/CheckboxListField/CheckboxListFieldView").default,
	},
	"form.DateFieldView": {
	...
	"form.DateTimeRangeFieldView": {
		lazy: () =>
			require("./form/DateTimeRangeField/DateTimeRangeFieldView").default,
	},
	...
	"format.BooleanFormatterView": {
		lazy: () =>
			require("./format/BooleanFormatter/BooleanFormatterView").default,
	},
	"format.DefaultFormatterView": {
		lazy: () =>
			require("./format/DefaultFormatter/DefaultFormatterView").default,
	},
	...
	"list.StepsView": { lazy: () => require("./list/Steps/StepsView").default },
	"list.StepItemView": { lazy: () => require("./list/Steps/StepItemView").default },
